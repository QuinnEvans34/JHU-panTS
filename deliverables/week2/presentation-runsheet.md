...
- [ ] `deliverables/week2/data-understanding-report.md` — DONE. Optional: add a 3-line "Update since drafting" note that the first plan lever (whole-box) already lifted specificity to 55%. Keeps the report consistent with what you say out loud.
- [ ] `deliverables/week2/eda-notebook.ipynb` — DONE. Make sure it is saved with outputs/charts rendered.
...
- [ ] Have the notebook open and pre-run, plus `deliverables/week2/diagrams/` ready in a second window for reserve visuals.
